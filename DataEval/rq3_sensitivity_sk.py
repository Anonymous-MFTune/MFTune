...
def append_all_system_summary(save_path='RQ3/scott_knott.csv', rank_decimals=2):
    """
...
def make_wide_layout(input_csv='RQ3/scott_knott.csv',
                     output_csv='RQ3/scott_knott_wide.csv',
                     metric_order=('r', 'mean')):
    """
...
def main():
    ...
    systems = ['mysql', 'postgresql', 'tomcat', 'httpd', 'gcc', 'clang']
    algorithms = ['MFTune-a1', 'MFTune-a3', 'MFTune-a5', 'MFTune-a7', 'MFTune-a9']
    ...
    for system in systems:
        ...
        for algorithm in algorithms:
            if algorithm in ['bestconfig', 'flash', 'smac', 'hebo', 'ga', 'promise']:
                ...
                print(f"{algorithm} Results:", all_results[algorithm])
            elif algorithm in ['hyperband', 'bohb', 'dehb', 'ga_multi_fidelity', 'priorband', 'MFTune-a1', 'MFTune-a3', 'MFTune-a5', 'MFTune-a7', 'MFTune-a9', 'MFTune-I', 'MFTune-II']:
        ...
        save_path = os.path.join('RQ3', 'scott_knott.csv')

        calculate_and_save_scott_knott(system, all_results, save_path)

        # add summary for all systems
        append_all_system_summary(save_path='RQ3/scott_knott.csv', rank_decimals=2)

        # convert to wide layout and save
        make_wide_layout(input_csv='RQ3/scott_knott.csv',
                         output_csv='RQ3/scott_knott_wide.csv',
                         metric_order=('r', 'mean'))
