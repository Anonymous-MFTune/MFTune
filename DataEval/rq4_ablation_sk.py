...
def append_all_system_summary(save_path='RQ4/scott_knott.csv', rank_decimals=2):
    """
...
def make_wide_layout(input_csv='RQ4/scott_knott.csv',
                     output_csv='RQ4/scott_knott_wide.csv',
                     metric_order=('r', 'mean')):
    """
...
def main():
    ...
    algorithms = ['MFTune-I', 'MFTune-II', 'MFTune-a5']
    ...
    for system in systems:
        ...
        save_path = os.path.join('RQ4', 'scott_knott.csv')

        calculate_and_save_scott_knott(system, all_results, save_path)

        # add summary for all systems
        append_all_system_summary(save_path='RQ4/scott_knott.csv', rank_decimals=2)

        # convert to wide layout and save
        make_wide_layout(input_csv='RQ4/scott_knott.csv',
                         output_csv='RQ4/scott_knott_wide.csv',
                         metric_order=('r', 'mean'))
