...
def plot_convergence_postfilter(system, algorithms, high_fidelity=None, optimization_target='throughput', budget=86400,
                                interval=7200):
    ...
    for i, algo in enumerate(algorithms):
        ...
        mean_cost, mean_perf, std_perf = sample_best_upto_fixed_intervals(mean_cost, mean_perf, std_perf, interval,
                                                                          max_points=14, system=system)
    ...
    # plt.ylim([450, 600])
    out_path = f'./RQ2/{system}_multi.pdf'
...
def main():
    ...
    # systems = ['httpd']
    # algorithms = ['flash', 'ga', 'smac', 'bestconfig', 'hyperband', 'hebo', 'ga_multi_fidelity', 'bohb', 'dehb', 'priorband', 'promise']
    # algorithms = ['smac', 'bestconfig', 'flash', 'ga', 'hebo', 'promise', 'MFTune-a5']
    algorithms = ['hyperband','bohb', 'dehb', 'priorband', 'MFTune-a5']
